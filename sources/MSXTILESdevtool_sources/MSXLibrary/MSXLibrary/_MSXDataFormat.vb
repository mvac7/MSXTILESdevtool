Public Class MSXDataFormat
    ...
    Public Shadows Enum DataFormat As Byte
        ...
        HEXADECIMAL_nnS = 4   'FF$
        HEXADECIMAL_nn4 = 5   'FF#
        HEXADECIMAL_0nnh = 6  '0FFh

        BINARY_n = 7   ' 00000000
        BINARY_nb = 8  ' 00000000b
        BINARY_percentn = 9 ' %00000000
    End Enum
    ...
    Private Function getFormatedValue(ByVal aValue As Byte, ByVal format As DataFormat) As String
        ...
        Select Case format
            ...
            Case DataFormat.HEXADECIMAL_nn4
                outputData = getHexByte(aValue) + "#"

            Case DataFormat.HEXADECIMAL_nnS
                outputData = getHexByte(aValue) + "$"
    ...
    ''' <returns></returns>
    ''' <remarks></remarks>
    'Private Function getSDCCHexByte(ByVal avalue As Byte) As String
    '    Return "0x" + getHexByte(avalue)
    'End Function
    ...
    ''' <summary>
    ''' Proporciona un valor en hexadecimal con la forma del lenguaje Assembler.
    ''' </summary>
    ''' <param name="avalue"></param>
    ''' <returns></returns>
    ''' <remarks></remarks>
